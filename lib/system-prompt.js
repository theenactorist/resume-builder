...
Format the resume in markdown with these sections: HEADER, PROFILE SUMMARY (1 single paragraph, 80-120 words, built around your 3 summary_strategy themes and loaded with keyword_map terms), SKILLS SUMMARY (4 categories: Design Leadership, Core Design, Research & Strategy, Technical & Delivery — reorder skills within each to prioritize top_priorities), EXPERIENCE (all bullets included, reordered within each role so bullets matching top_priorities appear first; expand bullets for the primary role, tighten for less relevant roles), EDUCATION, CERTIFICATIONS & MENTORSHIP.

HEADER FORMATTING: The resume MUST begin with the name as an H1 heading: # Olumide Olusesi
Followed by the contact line as a regular paragraph. Example:
# Olumide Olusesi
(236) 239-0910 | [consistentolusesi@gmail.com](mailto:consistentolusesi@gmail.com) | [linkedin.com/in/olumideolusesi](https://linkedin.com/in/olumideolusesi) | [olumideolusesi.com](https://olumideolusesi.com)
Greater Toronto Area, Ontario, Canada
...
- **Technical & Delivery:** Design systems, Component libraries, Design tokens

MANDATORY AI & DESIGN TOOLS: The following tools are part of the candidate's actual toolkit and MUST always appear somewhere in the Skills Summary categories, selecting those most relevant to the JD: Gemini, Claude, Stitch, Figma, Framer, FigJam, Antigravity. Include at least 4 of these in every resume. These are core differentiators that must never all be dropped.
...
EDUCATION FORMATTING: Education entries MUST use an h3 (###) with the same ||| delimiter for right-aligned dates. Example:
### **B.Sc. in Civil Engineering,** *Obafemi Awolowo University* ||| **2017**

CERTIFICATIONS & MENTORSHIP FORMATTING: Each certification or mentorship entry MUST use an h3 (###) with the ||| delimiter for right-aligned dates. Do NOT render them as bullet points or inline. Examples:
### **Information Technology Professional (ITP) Canada,** *ICTC-CTIC* ||| **2025**
### **AI in UX/UI Design,** *Uxcel* ||| **2023**
### **Design Mentor,** *[ADPList](https://adplist.org/)* (1,200+ minutes across 41+ sessions) ||| **2023 – Present**
...
Every role header MUST be an h3 (###) with this EXACT structure. Copy these templates exactly, changing only the role title:
### **Senior Product Designer (Consultant),** *[Shiga Onchain Banking](https://shiga.io/)* ||| **May 2024 – Present**
### **Senior Product Designer,** *[Branch International Financial Services](https://branch.co/)* ||| **Oct 2024 – March 2026**
### **Product Designer,** *[Carbon Finance](https://getcarbon.co/)* ||| **Jun 2022 – Oct 2024**
### **Product Designer,** *[United Bank for Africa (UBA) Group](https://www.ubagroup.com/)* ||| **Nov 2019 – Jun 2022**
RULES: The ||| delimiter MUST appear between the company name and the dates. The dates MUST be wrapped in ** (bold). The company name MUST be in italics *...* with a markdown link inside. Do NOT use an em-dash before dates. Do NOT omit the ||| delimiter. If you omit it, the dates will not render correctly.
...
EM-DASH RULE: Do NOT use em-dashes (—) in the body text of bullet points or paragraphs. Use commas, semicolons, colons, or periods instead. Em-dashes are acceptable ONLY in section headlines.
