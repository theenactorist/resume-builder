...
(236) 975-8435 | [consistentolusesi@gmail.com](mailto:consistentolusesi@gmail.com) | [linkedin.com/in/olumideolusesi](https://linkedin.com/in/olumideolusesi) | [olumideolusesi.com](https://olumideolusesi.com)
Greater Toronto Area, Ontario, Canada

PROFILE SUMMARY
Senior Product Designer with 7+ years leading end-to-end UX, UI, and content design for fintech products across KYC, lending, payments, and enterprise platforms. Canadian permanent resident with expertise in multi-market product design (Nigeria, Kenya, India), scalable design systems, and AI-augmented design operations. Has independently built 5+ production-ready apps and plugins using AI workflows and tools. Proven cross-functional leader who has served as de facto product owner, shipping revenue-generating products from zero to market.
...

{
  ...
  "cold_messages": {
    ...
    "subject_lines": {
      "recruiter": "Subject line for the recruiter message — bold, specific, not fluffy",
      "designer": "Subject line for the designer message — warm, peer-level, bold"
    }
  }
}
...
Format the resume in markdown with these sections in this exact order: HEADER, PROFILE SUMMARY (1 single paragraph, 80-120 words, built around your 3 summary_strategy themes and loaded with keyword_map terms; ALWAYS include the fact that Olumide has independently built 5+ production-ready apps and plugins using AI workflows and tools — this must appear regardless of whether the JD mentions AI), WORK EXPERIENCE (companies appear in FIXED order: Shiga → Branch → Carbon → UBA — never reorder companies; "primary role" means expand its bullets, NOT move it higher; only reorder bullets within each company), SKILLS SUMMARY (4 categories: Design Leadership, Core Design, Research & Strategy, Technical & Delivery — reorder skills within each to prioritize top_priorities), EDUCATION, CERTIFICATIONS & MENTORSHIP.
...
(236) 975-8435 ||| [consistentolusesi@gmail.com](mailto:consistentolusesi@gmail.com) ||| [linkedin.com/in/olumideolusesi](https://linkedin.com/in/olumideolusesi) ||| [Portfolio: olumideolusesi.com](https://olumideolusesi.com) ||| Greater Toronto Area, Ontario, Canada
# Olumide Olusesi
...
ROLE ORDERING RULE (NON-NEGOTIABLE): The four companies MUST appear in this exact order, top to bottom: 1. Shiga, 2. Branch, 3. Carbon, 4. UBA. This order NEVER changes — not for chronological sorting, not because Branch is the primary role match, not for any other reason. Do NOT sort by start date, end date, or relevance. The experience header templates below are listed in the mandatory order — copy that order exactly.
...
Role-Specific Guidance (these labels control bullet emphasis and expansion only — they do NOT affect company order):
- Branch: Primary role for most JDs. Expand bullets, lead with strongest metrics. Branch appears SECOND in the document after Shiga — do not move it higher.
...
Generate two LinkedIn DMs and two subject lines tailored to this specific role and company. Both messages use [Name] as a literal placeholder the sender will replace before sending.

RECRUITER MESSAGE (cold_messages.recruiter):
Target: A recruiter or HR professional at the company.
Goal: Ask them to look at the resume directly.
Structure:
1. Open with the specific role name and company — no filler. Example: "Hi [Name], I came across the [Job Title] role at [Company] and wanted to reach out directly."
2. One sentence company-specific hook — use the COMPANY HOOK if provided, otherwise search the JD for specific verifiable signals: industry awards, recognition, funding rounds, named products, or concrete stated values. Do NOT use generic mission statements ("simplifying finance", "making banking accessible") — these are interchangeable across companies and must be avoided. The hook must name something specific that only this company has or has done.
3. 2 sentences on Olumide's design approach and what he brings to the craft — qualitative, human, specific to the domain. Do NOT list metrics or numbers here (those are in the resume). Focus on what it feels like to work with him or what he cares about as a designer: the edge cases, the user clarity, the zero-to-one instinct, the systems thinking. Make it scannable and resonant, not a data report.
4. Direct ask: "I'd love for you to take a look at my attached resume directly."
5. Portfolio mention: "My portfolio is at olumideolusesi.com."
6. Specific CTA: "Would a quick 15-minute chat work? You can also reach me at (236) 975-8435."
...
2. One sentence company hook (same source as recruiter — hook field or specific JD signal, never a generic mission statement), framed as what genuinely excited you about the company, not just the role.
3. 1-2 sentences on shared craft territory — what you both work on (consumer fintech, data products, AI, etc.). Keep it collegial and qualitative. No metrics — this is a peer conversation, not a pitch deck.
4. Soft referral ask: "If you're open to it, a referral from someone on the team would mean a lot."
5. Portfolio mention: "My portfolio is at olumideolusesi.com."
6. CTA: "Would love to grab 15 minutes to hear about your experience on the team — happy to connect on a call or drop me a line at (236) 975-8435."
7. Sign off: "Thanks, [Name]. — Olumide"

SUBJECT LINES (cold_messages.subject_lines):
Generate one subject line for each message. Subject lines must be bold, specific, and truthful. Style benchmark: "I'm Super Confident I'm Monarch's Next Product Designer Hire" — direct, confident, names the company and role.

RECRUITER subject line (cold_messages.subject_lines.recruiter):
- Confident and direct — the recruiter is evaluating fit quickly
- Must name the role or the company (or both)
- No em-dashes, no fluff, no questions
- Examples of the right register: "I'm Confident I'm [Company]'s Next [Job Title]", "Re: [Job Title] — I've Done This Exact Work", "Your [Job Title] Search Might Already Be Over"
- Do NOT write: "Excited About the Opportunity at [Company]", "Following Up on My Application", "Talented Designer Seeking New Role"

DESIGNER subject line (cold_messages.subject_lines.designer):
- Warm and peer-level, but still bold — not timid
- Should signal that this is a designer-to-designer message
- Examples of the right register: "One Designer to Another: I'm Joining Your Team Soon (Hopefully)", "Fellow Designer Applying at [Company] — Wanted to Connect First", "Applying to Your Team at [Company] — Wanted to Reach You First"
- Do NOT write: "Hi There!", "Quick Question", "Hoping to Connect"
...
- The hook must be specific and verifiable — an award, a named product, a funding round, a concrete stated value. Never a mission statement paraphrase.
- If a COMPANY HOOK is provided in the user message, it MUST appear in both messages verbatim
- Value prop is qualitative, not quantitative — metrics belong in the resume, not the DM
