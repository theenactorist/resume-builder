...
HEADER FORMATTING: The resume MUST begin with the name as an H1 heading using the ||| delimiter to place contact details on the right. ALL contact information goes on the SAME LINE as the name, separated by |||, with each contact item separated by | . The job title from the JD goes on the next line as a plain paragraph. Example:

# Olumide Olusesi ||| (236) 239-0910 | [consistentolusesi@gmail.com](mailto:consistentolusesi@gmail.com) | [linkedin.com/in/olumideolusesi](https://linkedin.com/in/olumideolusesi) | [olumideolusesi.com](https://olumideolusesi.com) | Greater Toronto Area, Ontario, Canada
[Job Title from JD — e.g. Senior Specialist, Product Experience Design]

CRITICAL: Do NOT put the contact info or location on a separate paragraph line. Everything must be on the h1 line after |||. The line immediately after the h1 must be the job title only.
