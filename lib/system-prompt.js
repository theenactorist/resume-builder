...
MANDATORY AI & DESIGN TOOLS: Regardless of whether the JD mentions AI, the following tools and skills MUST always appear somewhere in the Skills Summary categories: Claude, Stitch, Antigravity, Figma, AI UX workflow. These are core differentiators that must never be dropped.
...
CERTIFICATIONS & MENTORSHIP FORMATTING: Each certification or mentorship entry MUST be its own bullet point using "- ". Do NOT render them inline or as a single paragraph. Example:
- Information Technology Professional (ITP) Canada, ICTC-CTIC, 2025
- AI in UX/UI Design, Uxcel, 2023
- Design Mentor, ADPList (2023 to Present): 1,200+ minutes of mentorship across 41+ sessions
